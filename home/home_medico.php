        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link active" aria-current="page" href="#">Saludos, Dr/a. <?php echo $_SESSION['nombre'] ?></a>
    ...
    <main>
        <div class="main-grid-wrapper">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <p class="card-text">Realizar Diagnóstico.</p>
                    <a href="../diagnostico/realizar_diagnostico.php" class="btn btn-primary">Ir al sitio</a>
                </div>
            </div>
